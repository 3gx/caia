 ...
 * Downloads files to memory, resizes large images, and prepares them for OpenCode.
...
/**
 * Check if mimetype is an image type supported by OpenCode.
 */
...
/**
 * Check if file is a binary type that cannot be read by OpenCode.
 */
...
/**
 * Process Slack files for OpenCode consumption.
