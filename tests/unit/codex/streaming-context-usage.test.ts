...
vi.mock('../../../codex/src/slack-retry.js', () => ({
...
vi.mock('../../../codex/src/blocks.js', async () => {
  const actual = await vi.importActual<typeof import('../../../codex/src/blocks.js')>('../../../codex/src/blocks.js');
  return {
    ...actual,
    buildActivityBlocks,
  };
...
describe('StreamingManager context usage (activity line)', () => {
  it('uses cumulative totals for context usage', async () => {
    const { StreamingManager } = await import('../../../codex/src/streaming.js');
