...
import fs from 'fs';
import { getSessionFilePath } from '../../../claude/src/session-reader.js';
...
describe('getThinkingContentFromSession', () => {
  ...
  it('should return null when session file does not exist', async () => {
    ...
    const { getThinkingContentFromSession } = await import('../../../claude/src/slack-bot.js');
...
describe('updateThinkingMessageWithRetry', () => {
  ...
  it('should return true on successful update (first try)', async () => {
    ...
    const { updateThinkingMessageWithRetry } = await import('../../../claude/src/slack-bot.js');
  ...
  describe('stripAnsiCodes', () => {
    it('should strip color codes', async () => {
      const { stripAnsiCodes } = await import('../../../claude/src/slack-bot.js');
