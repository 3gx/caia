...
describe('model-cache', () => {
  ...
  let getAvailableModels: typeof import('../../../claude/src/model-cache.js').getAvailableModels;
  let refreshModelCache: typeof import('../../../claude/src/model-cache.js').refreshModelCache;
  let isModelAvailable: typeof import('../../../claude/src/model-cache.js').isModelAvailable;
  let getModelInfo: typeof import('../../../claude/src/model-cache.js').getModelInfo;
  let getDefaultModel: typeof import('../../../claude/src/model-cache.js').getDefaultModel;
  ...
  beforeEach(async () => {
    ...
    const modelCache = await import('../../../claude/src/model-cache.js');
