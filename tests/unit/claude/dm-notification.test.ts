...
// Mock markdown-png
vi.mock('../../../claude/src/markdown-png.js', () => ({
  markdownToPng: vi.fn().mockResolvedValue(Buffer.from('')),
}));

// Mock abort-tracker
vi.mock('../../../claude/src/abort-tracker.js', () => ({
...
import { sendDmNotification, clearDmNotificationDebounce, DM_DEBOUNCE_MS, truncateQueryForPreview } from '../../../claude/src/slack-bot.js';
