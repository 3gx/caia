...
import { parseCommand, extractInlineMode, extractMentionMode, extractFirstMentionId } from '../../../claude/src/commands.js';
...
import { findSessionFile } from '../../../claude/src/session-reader.js';
