...
vi.mock('../../../claude/src/session-manager.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../../claude/src/session-manager.js')>();
  return {
    ...actual,
...
import * as activityThread from '../../../claude/src/activity-thread.js';
...
describe('terminal-watcher', () => {
  ...
  describe('polling behavior', () => {
    ...
    it('should post tool-only messages without file attachments', async () => {
      ...
      const { readActivityLog } = await import('../../../claude/src/session-event-stream.js');
