...
import { syncMessagesFromOffset, MessageSyncState, SyncResult } from '../../../claude/src/message-sync.js';
import * as sessionReader from '../../../claude/src/session-reader.js';
import * as sessionManager from '../../../claude/src/session-manager.js';
import * as sessionEventStream from '../../../claude/src/session-event-stream.js';
import * as blocks from '../../../claude/src/blocks.js';
...
vi.mock('../../../claude/src/session-manager.js', () => ({
...
vi.mock('../../../claude/src/session-event-stream.js', () => ({
  readActivityLog: vi.fn(() => Promise.resolve([])),
}));

// Mock blocks module
vi.mock('../../../claude/src/blocks.js', () => ({
...
vi.mock('../../../claude/src/streaming.js', () => ({
...
describe('message-sync', () => {
  ...
  describe('syncMessagesFromOffset', () => {
    ...
    it('should post turn with user input, activity, and text response', async () => {
      ...
      const { postThinkingToThread } = await import('../../../claude/src/activity-thread.js');
    ...
    it('should post activity as thread replies with threading enabled', async () => {
      ...
      // Import activity-thread to check calls
      const { postThinkingToThread, postActivityToThread } = await import('../../../claude/src/activity-thread.js');
  ...
  describe('groupMessagesByTurn', () => {
    ...
    it('groups messages into turns at user input boundaries', async () => {
      ...
      const { groupMessagesByTurn } = await vi.importActual<typeof sessionReader>('../../../claude/src/session-reader.js');
  ...
  describe('segment-specific activity filtering', () => {
    ...
    it('should post INTERLEAVED activity messages for multi-segment turn', async () => {
      ...
      // Import activity-thread to check calls
      const { postActivityToThread } = await import('../../../claude/src/activity-thread.js');
