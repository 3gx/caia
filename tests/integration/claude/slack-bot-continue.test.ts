...
vi.mock('../../../claude/src/claude-client.js', () => ({
  streamClaude: vi.fn(),
...
vi.mock('../../../claude/src/concurrent-check.js', () => ({
...
vi.mock('../../../claude/src/model-cache.js', () => ({
...
vi.mock('../../../claude/src/terminal-watcher.js', () => ({
...
vi.mock('../../../claude/src/ff-abort-tracker.js', () => ({
  markFfAborted: vi.fn(),
...
import { getSession, saveSession, getMessageMapUuids, clearSyncedMessageUuids, saveActivityLog, getOrCreateThreadSession } from '../../../claude/src/session-manager.js';
import { startWatching, stopWatching, isWatching, getWatcher, onSessionCleared, updateWatchRate, postTerminalMessage } from '../../../claude/src/terminal-watcher.js';
import { startClaudeQuery } from '../../../claude/src/claude-client.js';
import { readNewMessages, sessionFileExists, extractTextContent, groupMessagesByTurn } from '../../../claude/src/session-reader.js';
