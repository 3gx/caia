/**
 * SDK-Live Tests for /ff Activity - Generating
 *
 * Run with: npm test -- src/__tests__/sdk-live/ff-activity-generating.test.ts
 */
...
describe.skipIf(SKIP_LIVE)('/ff Activity - Generating', { timeout: 120000 }, () => {
