/**
 * SDK-Live Tests for Session Event Stream API - Init Event
 *
 * Run with: npm test -- src/__tests__/sdk-live/session-event-stream-init.test.ts
 */
...
import { readAllSessionEvents } from '../../../claude/src/session-event-stream.js';
...
describe.skipIf(SKIP_LIVE)('Session Event Stream - Init', { timeout: 120000 }, () => {
